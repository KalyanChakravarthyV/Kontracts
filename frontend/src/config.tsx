...
export const SuperTokensConfig = {
    ...
    recipeList: [
        ...
        firstFactors: ["thirdparty", "passwordless"],
        override: {
            functions: (originalImplementation) => ({
                ...
                getRequiredSecondaryFactorsForUser: async () => {
                    return [MultiFactorAuth.FactorIds.LINK_EMAIL, MultiFactorAuth.FactorIds.OTP_EMAIL];
                },
            }),
        }
    }),
...
export const PreBuiltUIList = [ThirdPartyPreBuiltUI, PasswordlessPreBuiltUI, MultiFactorAuthPreBuiltUI, EmailVerificationPreBuiltUI];
